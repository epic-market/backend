...
{
    public class AlterScript9 : BaseAlterScript,IAlterScript
    {
        private readonly ApplicationDbContext dbContext;

        public AlterScript9(ApplicationDbContext dbContext):base(dbContext)
        {
        ...
        public void Execute()
        {
            ...
            if (!dbContext.Entity.Any(cm => cm.Name == "CatelogVariant"))
            {
                var entity = new Entity
                {
                    Name = "CatelogVariant",
                    Description = "CatelogVariant",
                };
